...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
	...
	return (
		<div
			...
			ref={containerRef}
		>
			<div className="max-w-7xl text-center mx-auto pt-20 px-4 md:px-8 lg:px-10">
				<motion.h2
					className="text-2xl font-medium md:text-5xl mb-4 text-black dark:text-white"
					initial={{ opacity: 0, y: 20 }}
					whileInView={{ opacity: 1, y: 0 }}
					viewport={{ once: true, margin: "-100px" }}
					transition={{ duration: 0.6 }}
				>
					<SparklesText>How We Deliver Sales-Ready Prospects</SparklesText>
				</motion.h2>
				<motion.p
				...
				>
					A Systematic Approach to Pipeline Generation
				</motion.p>
			</div>
				...
				{data.map((item, index) => (
					...
					>
						...
						<div className="relative pl-20 pr-4 md:pl-4 w-full">
							...
							<motion.div variants={itemVariants}>{item.content}</motion.div>
						</div>
					</motion.div>
				))}
				<div
